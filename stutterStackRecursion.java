/*
Write a method stutter that accepts a Stack of integers as a parameter and 
...
Also, you must not use any auxillary data structures to solve this problem. 
If the original stack is empty, the result should be empty as well.
*/

public Stack<Integer> stutter(Stack<Integer> s){
    if(s.isEmpty() || s == null){
        return s;
    }
    else{
